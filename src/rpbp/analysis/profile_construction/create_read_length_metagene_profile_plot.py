...
default_xlabel_start = (
    "Position of P-site relative to start (nt)\nRed: TIS. Green: TIS -12"
)
default_xlabel_end = (
    "Position of P-site relative to stop (nt)\nBlue: Translation termination"
)
...
def main():
    ...
    parser.add_argument(
        "length", help="The length to use for the visualization", type=int
    )
    ...
    parser.add_argument(
        "--xlabel-start",
        help="The label for the x-axis for TIS",
        default=default_xlabel_start,
    )
    parser.add_argument(
        "--xlabel-end",
        help="The label for the x-axis for TTS",
        default=default_xlabel_end,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--step", help="The step for the x-axis", type=int, default=default_step
    )
    ...
    parser.add_argument(
        "--start-downstream",
        type=int,
        help="The number of " "bp downstream of the TIS to show",
    ...
    parser.add_argument(
        "--end-downstream",
        type=int,
        help="The number of " "bp downstream of the TTS to show",
